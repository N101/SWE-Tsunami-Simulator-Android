...
namespace Solvers {
    ...
    public:
        ...
        void computeNetUpdates(
            ...
            assign_parameters(hLeft, hRight, huLeft, huRight, bLeft, bRight, huLeft / hLeft, huRight / hRight);
            ...
            // setFluxFuncDiffBathymetry_1(fluxFuncDiff, deltaPsi, z1, z2);
            setFluxFuncDiffBathymetry_2(fluxFuncDiff, deltaPsi);
        ...
        void computeAlphas(
                T (&alphas)[2], const T (&fluxFuncDiff)[2], const T (&roeEigenMatrix)[2][2], const T (&inversed)[2][2]
        ) {
            // inverseMatrix(roeEigenMatrix, inversed);
            // setfluxFunctionDiff(fluxFuncDiff);
        ...
        // set new flux function
        // 1.version
        void
        setFluxFuncDiffBathymetry_1(T (&funFuncDiff)[2], const T (&deltaPsi)[2], const T (&z1)[2], const T (&z2)[2]) {
            funFuncDiff[0] = z1[0] + z2[0] + deltaPsi[0];
            funFuncDiff[1] = z1[1] + z2[1] + deltaPsi[1];
        }

        // 2.version
        void setFluxFuncDiffBathymetry_2(T (&fluxFuncDiff)[2], const T (&deltaPsi)[2]) {
