...
std::string Writers::VTKSWEWriter::generateFileName() const {
 ...
 Writers::VTKSWEWriter::VTKSWEWriter(
...
void Writers::VTKSWEWriter::writeTimeStep(
    ...
    //assert(vtkFile.good()); cause Exception on click on emulator
