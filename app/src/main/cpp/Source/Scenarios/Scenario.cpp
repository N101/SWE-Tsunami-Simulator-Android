...
RealType
Scenarios::Scenario::getVelocityU([[maybe_unused]] RealType x, [[maybe_unused]] RealType y) const {
    return RealType(0.0);
}

RealType
Scenarios::Scenario::getVelocityV([[maybe_unused]] RealType x, [[maybe_unused]] RealType y) const {
    return RealType(0.0);
}
...
RealType Scenarios::Scenario::getDisplacement(RealType x, RealType y) const {
    return RealType(0.0);
}
